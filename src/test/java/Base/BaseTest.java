...
public class BaseTest {
    ...
    public void testSetup(java.lang.reflect.Method method) {
        ...
        ExtentManager.createReport(method.getName());              // new report file per test
    ...
    public void testTeardown(ITestResult result) {
        ...
        ExtentManager.flushReport();                                 // write this test's HTML
        PdfReportUtils.convertHtmlToPdf(result.getMethod().getMethodName()); // convert it to PDF
